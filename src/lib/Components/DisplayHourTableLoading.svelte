...
<div>
	<div class="flex flex-row gap-4 items-start">
		...
		>
			<div class="my-auto max-h-fit space-y-2 py-3.5">
				<div class="h-2.5 bg-purple-400 animate-pulse rounded-full" />
				<div class="h-2.5 bg-purple-400 animate-pulse rounded-full" />
			</div>
		</div>
		<div
		...
		>
			<div class="my-auto max-h-fit space-y-2 py-3.5">
				<div class="h-2.5 bg-orange-400 animate-pulse rounded-full" />
				<div class="h-2.5 bg-orange-400 animate-pulse rounded-full" />
			</div>
		</div>
	</div>
